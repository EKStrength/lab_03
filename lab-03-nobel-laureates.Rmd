...
```{r}
#I can confirm that I have a data frame with 228 observations.
```
...
```
It is apparent that most of the nobel prize winners in all four categories are from the U.S.
...
5.  Add a second variable to your visualization from Exercise 3 based on whether the laureate was born in the US or not.
    ...
    Yes, the visualization does support Buzzfeed's claim. The majority of Nobel Prize winners were born in countries other than the U.S. even if they live in the U.S. now. Immigrants win a large portion of the prizes. 
...
***Germany is the most common followed closely by UK and Japan.***
